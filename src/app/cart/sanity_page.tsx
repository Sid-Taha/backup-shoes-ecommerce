  ...
  import userIdFunction, { userPostSanity } from "@/services/userId";
import { cartFetchSanity } from "@/services/orders";
  ...
  export default function ShoppingCart() {
    ...
    useEffect(() => {
      async function getUserId(){
        const user = await userPostSanity() 
        if (user) {
          setUser(user)
        }
      }
    ...
    useEffect(() => {
      const getData = async () => {
        const cart = await cartFetchSanity()
      }
